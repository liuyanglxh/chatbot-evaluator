...
from windows.result_popup_window import ResultPopupWindow  # 统一使用 ResultPopupWindow
...
class BatchEvaluationExecutor:
    ...
    def _show_results(self):
        """显示结果 - 使用统一的ResultPopupWindow"""
        # 关闭进度窗口
        self.progress_window.destroy()

        # 使用统一的结果窗口
        ResultPopupWindow(self.progress_window.master, self.results, self.evaluator_info)
